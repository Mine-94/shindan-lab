...
const quizzes = [
  ...
  },
  {
    id: 'kakure-chara',
    title: 'かくれキャラ診断',
    subtitle: '友達があなたをどう見ているか、こっそり覗いてみませんか？',
    emoji: '🕵️',
    themeColor: '#d9822b',
    intro: '本人が気づいていない"友達から見た自分"は、意外と一貫しているもの。8つの質問で、周りがこっそり感じているあなたの"かくれキャラ"を診断します。',
    questions: [
      {
        text: 'グループ旅行の行き先を決めるとき、あなたは？',
        options: [
          { text: 'さりげなく話を誘導して、結局行きたい場所にまとめる', type: 'kakure-boss' },
          { text: '「どこでもいいよ〜」と言いつつ、実は密かに行きたい場所がある', type: 'mystery-cat' },
          { text: 'みんなの希望を聞いた上で、一番丸く収まる案を出す', type: 'sharp-fox' },
          { text: '「楽しければどこでもいい！」とテンションを上げる', type: 'sunshine' },
        ],
      },
      {
        text: 'グループチャットでの自分のポジションは？',
        options: [
          { text: 'あまり発言しないが、一言で流れを変えることがある', type: 'kakure-boss' },
          { text: 'スタンプだけ送って、何を考えているか誰にも分からない', type: 'mystery-cat' },
          { text: '全部読んでいるが、あえて反応しないことも多い', type: 'sharp-fox' },
          { text: '誰よりも早く反応して、場を盛り上げる', type: 'sunshine' },
        ],
      },
      {
        text: '友達同士でケンカが起きたら？',
        options: [
          { text: 'どちらの味方もせず、自然と仲直りする流れに持っていく', type: 'kakure-boss' },
          { text: '特に関わらず、いつも通り自分のペースで過ごす', type: 'mystery-cat' },
          { text: '裏で両方の話を聞いて、根本の原因を見抜いている', type: 'sharp-fox' },
          { text: 'とにかく明るい話題を振って、空気を変えようとする', type: 'sunshine' },
        ],
      },
      {
        text: '誰かに褒められたときの反応は？',
        options: [
          { text: '「そんなことないよ」と謙遜しつつ、内心はしっかり自信がある', type: 'kakure-boss' },
          { text: '照れて、何を言っているのか自分でも分からなくなる', type: 'mystery-cat' },
          { text: '「知ってる」と冗談っぽく返す', type: 'sharp-fox' },
          { text: '大げさに喜んで、その場のテンションが上がる', type: 'sunshine' },
        ],
      },
      {
        text: '新しい環境（クラス替え・転職など）に入ったら？',
        options: [
          { text: '目立たないうちに、誰が誰と仲良いかをすぐ把握する', type: 'kakure-boss' },
          { text: 'マイペースに過ごしていたら、気づいたら独自のポジションができている', type: 'mystery-cat' },
          { text: '表面は静かにしつつ、頭の中で人間関係を整理している', type: 'sharp-fox' },
          { text: '積極的に話しかけて、一気に輪を広げる', type: 'sunshine' },
        ],
      },
      {
        text: '友達に相談を持ちかけられたら？',
        options: [
          { text: '余計なことは言わず、必要なタイミングで一言だけ言う', type: 'kakure-boss' },
          { text: '話は聞くけど、リアクションが薄くて何を考えているか分からないと言われる', type: 'mystery-cat' },
          { text: '話を聞きながら、実はもう答えを出している', type: 'sharp-fox' },
          { text: '全力で共感して、一緒に盛り上がってしまう', type: 'sunshine' },
        ],
      },
      {
        text: '集合写真を撮るとき、あなたは？',
        options: [
          { text: '特に指示していないのに、なぜか自然と真ん中に立っている', type: 'kakure-boss' },
          { text: '気づいたら端っこや変な角度に写っている', type: 'mystery-cat' },
          { text: '全員が良い顔になるよう、さりげなく立ち位置を調整する', type: 'sharp-fox' },
          { text: '「もう一枚撮ろう！」とみんなを盛り上げる', type: 'sunshine' },
        ],
      },
      {
        text: '友達が本音であなたをどう見ていると思う？',
        options: [
          { text: '「あの人がいると安心する」と思われていそう', type: 'kakure-boss' },
          { text: '「何を考えているか分からないけど、なぜか気になる」と思われていそう', type: 'mystery-cat' },
          { text: '「実は一番いろいろ見抜いている」と思われていそう', type: 'sharp-fox' },
          { text: '「あの人がいると場が明るくなる」と思われていそう', type: 'sunshine' },
        ],
      },
    ],
    results: {
      'kakure-boss': {
        title: '隠れボス型',
        emoji: '👑',
        desc: '前に出て仕切るタイプではないのに、気づけばグループの流れはいつもあなたの方向に進んでいる。友達はそれとなく気づいていて、「なんだかんだ頼りになる人」として、心の中であなたを"かくれリーダー"と呼んでいるかもしれません。',
        shareText: '私の"かくれキャラ"は「隠れボス型」👑 前に出なくても場を仕切ってるらしい',
      },
      'mystery-cat': {
        title: '気まぐれ猫型',
        emoji: '🐈',
        desc: '何を考えているのか読めないところが、逆に友達を惹きつけています。マイペースで自由に見えるあなたを、周りは"つかみどころのないけど憎めない人"として、こっそり気にかけているはずです。',
        shareText: '私の"かくれキャラ"は「気まぐれ猫型」🐈 何考えてるか分からないってよく言われる',
      },
      'sharp-fox': {
        title: 'かくれ策士型',
        emoji: '🦊',
        desc: '表面は落ち着いているけど、実はほとんど全部お見通し。友達はうすうす気づいていて、「実は一番いろいろ分かってる人」として、あなたを頼りにしているのかもしれません。',
        shareText: '私の"かくれキャラ"は「かくれ策士型」🦊 実は全部見えてるらしい',
      },
      sunshine: {
        title: 'ムードメーカー型',
        emoji: '🎉',
        desc: 'あなたがいるだけで、場の空気が一段明るくなる。友達は口には出さなくても、「あの人がいると楽しい」と、あなたの存在をちゃんと感じ取っています。',
        shareText: '私の"かくれキャラ"は「ムードメーカー型」🎉 いるだけで空気変わるらしい',
      },
    },
  },
];
